module.exports = function(API){
	...
	this.api = {
		errors: [
			...
			[ErrorCodes.FailedHost, "Failed to connect to room host. If this problem persists please see the troubleshooting guide: https://moo-hoo.com/Connection-Issues"],
			...
			[ErrorCodes.NoProxyIdentityProblem, "Original backend is not compatible with the login system, so the identity token and identity events are disabled."],
			...
			[ErrorCodes.AnonymousJoinBlocked, "Joining anonymously is blocked"]
