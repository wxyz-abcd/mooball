module.exports = function(API, params){
  ...
  Renderer.call(this, { // Every renderer should have a unique name.
    ...
    version: "0.5",
    author: "abc",
    description: `This is an older and outdated version of the default renderer currently used in Mooball. Use +, - keys for zoom in-out. Disable followMode to zoom using mouse wheel.`
  });
  ...
  MooballRenderer.setSmoothingEnabled = function(ctx, enabled){ // Gi
    ctx.imageSmoothingEnabled = enabled;
    ctx.mozImageSmoothingEnabled = enabled;
  };
  MooballRenderer.prototype = {
    ...
    render: function(roomState){ // Kc
      ...
      this.resizeCanvas();
      MooballRenderer.setSmoothingEnabled(this.ctx, true);
    ...
    drawBackground: function(stadium){ // Sq
      MooballRenderer.setSmoothingEnabled(this.ctx, false);
  ...
  this.initialize = function(){
    ...
    rendererObj = new MooballRenderer();
  };
