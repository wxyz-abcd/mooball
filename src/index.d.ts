...
type TextToNumberMap = {
  [x: string]: number;
};
type NumberToTemplateStringMap = {
  [x: number]: TemplateString;
};
type IdentityData = null | {
  json?: {
    id: uint32,
    user: {
      id: uint32,
 ...
 */
declare enum PlayerPositionInGame {

  /**
   * No position. Unfortunately specific to Mooball. :)
   */
  None = 0,
...
/**
 * The base class for all Mooball events.
 */
declare class MooballEvent {
 ...
 */
declare class SendAnnouncementEvent extends MooballEvent {
 ...
 */
declare class SetLimitEvent extends MooballEvent {
 ...
 */
declare class SetAvatarEvent extends MooballEvent {
 ...
 */
declare class SetPlayerTeamEvent extends MooballEvent {
 ...
 */
declare class SetStadiumEvent extends MooballEvent {
 ...
 */
declare class SetTeamColorsEvent extends MooballEvent {
 ...
 */
declare class SetTeamsLockEvent extends MooballEvent {
 ...
 */
declare class JoinRoomEvent extends MooballEvent {
 ...
 */
declare class SetHeadlessAvatarEvent extends MooballEvent {
 ...
 */
declare class PauseResumeGameEvent extends MooballEvent {
 ...
 */
declare class SendChatEvent extends MooballEvent {
 ...
 */
declare class SendInputEvent extends MooballEvent {
 ...
 */
declare class SendChatIndicatorEvent extends MooballEvent {
 ...
 */
declare class CustomEvent extends MooballEvent {
 ...
 */
declare class BinaryCustomEvent extends MooballEvent {
 ...
 */
declare class IdentityEvent extends MooballEvent {
 ...
 */
declare class KickBanPlayerEvent extends MooballEvent {
 ...
 */
declare class ReorderPlayersEvent extends MooballEvent {
 ...
 */
declare class SetDiscPropertiesEvent extends MooballEvent {
 ...
 */
declare class SetKickRateLimitEvent extends MooballEvent {
 ...
 */
declare class PingEvent extends MooballEvent {
 ...
 */
declare class SetRoomNameEvent extends MooballEvent {
 ...
 */
declare class StadiumAddObjectEvent extends MooballEvent {
...
/**
 * The event message structure that is created by the host to update an existing stadium object. 
 */
declare class StadiumUpdateObjectEvent extends MooballEvent {
...
/**
 * The event message structure that is created by the host to remove an existing stadium object. 
 */
declare class StadiumRemoveObjectEvent extends MooballEvent {
 ...
 */
declare class SetPlayerEnergyEvent extends MooballEvent {
 ...
 */
declare class SendDirectionEvent extends MooballEvent {
 ...
 */
declare class ControlsEvent extends MooballEvent {
 ...
 */
declare class UpdateCssVarEvent extends MooballEvent {
 ...
 */
declare class SetPlayerSkinEvent extends MooballEvent {
 ...
 */
declare class SetPlayerCssVarEvent extends MooballEvent {
...
type CreateRoomParams = {
   ...
   * @returns void.
   */
  onError?(error: IHBError, playerId: uint16): void;
   ...
   * 
   * @param peerId The thrown error.
   * @param ip Id of the player that caused the error.
   * @param sdp The thrown error.
   * @param candidates The thrown error.
   * 
   * @returns null|string.
   */
  onConnectionAttempt?(peerId: uint32, ip: string, sdp: string, candidates: any[]): (null|string);
};
...
type CommonNetworkRoomParams = {
  ...
  /**
   * The `RoomConfig` object that contains all the main callbacks of this room. Default value is `null`. Note that the api will generate an empty config if you do not provide one. Look at https://github.com/wxyz-abcd/mooball/tree/main/examples/roomConfigs for example RoomConfigs to use here.
   */
  config?: RoomConfig;

  /**
   * The `Renderer` object that will render the game. The object should be derived from the provided `Renderer` class. Default value is `null`. Look at https://github.com/wxyz-abcd/mooball/tree/main/examples/renderers for example Renderers to use here.
   */
  renderer?: Renderer;

  /**
   * An array of `Plugin` objects to be used. the objects should be derived from the provided `Plugin` class. Default value is `[]`. Look at https://github.com/wxyz-abcd/mooball/tree/main/examples/plugins for example Plugins to use here.
   */
  plugins?: Plugin[];

  /**
   * An array of `Library` objects to be used. the objects should be derived from the provided `Library` class. Default value is `[]`. Look at https://github.com/wxyz-abcd/mooball/tree/main/examples/libraries for example Library's to use here.
   */
  libraries?: Library[];

  /**
   * Mooball's version number. Other clients cannot join this room if their version number is different than this number. Default value is `9`.
   */
  version?: int;
  ...
  /**
   * A token that represents a user data in moo-hoo.com's database. If successful, room will create and emit an IdentityEvent for this player.
   */
   ...
   * @returns void.
   */
  onConnInfo?(state: ConnectionState, extraInfo?: string|IHBError): void;
};


type CommonNetworkRoomReturnType = {
...
interface StreamWatcherRoom extends SandboxRoomBase {
...
interface SandboxRoom extends SandboxRoomBase {
   ...
   * @param data The new identity data.
   * @param signature Signature of the identity data.
   * @param byId Id of the player who triggered this identity event.
   * 
   * @returns void.
   */
  setPlayerIdentity(id: uint16, data: IdentityData, signature: ArrayBuffer, byId: uint16): void;
}
...
interface CreateSegmentFromObjParams {
...
type RefreshRoomTokenReturnValue = {
  code: int;
  value: string|Error;
}
...
type GenerateRoomIdReturnValue = {
  roomId: string, 
  roomEndpoint: string, 
  newToken: string
}
...
interface CreateJointFromObjParams {
...
interface SandboxModeFunctions {
   ...
   * 
   * @param value New direction value of the current player.
   * 
   * @returns void.
   */
   ...
   * 
   * @param id Id of the player whose skin will be modified.
   * @param skin New skin value of the player.
   * 
   * @returns void.
   */
  setPlayerSkin(id: uint32, skin: Texture|null): void;
  
  /**
   * Sets the cssVar attribute of a player to change its appearance in the room gui.
   * 
   * @param id Id of the player whose cssVar will be modified.
   ...
   * @returns void.
   */
  addStadiumObject(type: uint8, value: object): void;
   ...
   * @returns void.
   */
  updateStadiumObject(type: uint8, id: uint16, value: object): void;
   ...
   * 
   * @returns An instance of StadiumRemoveObjectEvent.
   */
  removeStadiumObject(type: uint8, id: uint16): void;
  
  /**
   * Sets the overtime limit.
   * 
   * @param value The desired overtime limit of the game.
   * 
   * @returns void.
   */
  setOvertimeLimit(value: uint32): void;
   ...
   * @returns void.
   */
  setPlayerDirection(id: uint32, value: number): void;
  
  /**
   * Introduces a new game input control and assigns it to the next bit of player.input value.
   * 
   * @param name Unique name of the input control.
   * @param keys Keycodes for the default keys of this input control.
   * 
   * @returns void.
   */
  addControl(name: string, keys: int16[]): void;
  
  /**
   * Remove an existing game input control. This function might break the game input logic completely.
   * 
   * @param name Unique name of the input control to be removed.
   * 
   * @returns void.
   */
   ...
   * 
   * @param teamId Id of the team whose score is desired to be changed.
   * @param value New score for the team.
   * 
   * @returns void.
   */
  setTeamScore(teamId: uint8, value: number): void;
...
interface FakeEventTriggers {
   ...
   * @param byId Id of the player who will look like he/she sent this event.
   */
  fakeSetStadium(value: IStadium, byId: uint16): void;
...
/**
 * This class defines a serializable color stop.
 */
type ColorStop = {
  ...
  /**
   * At what percentage this color ends. Must be between 0 and 1.
   */
  stop: number;
};

/**
 * This class defines a serializable color stop array.
 */
type ColorStops = {

  /**
   * Array of color stops, ascendingly ordered by stop values, should be starting at 0 and ending at 1.
   */
  array: ColorStop[];
};

/**
 * This interface defines a serializable Texture.
 */
interface Texture{
...
/**
 * This class defines a solid color Texture.
 */
interface SolidTexture extends Texture{

  /**
   * The color of the solid Texture.
   */
  color: int32;
}

/**
 * This class defines a linear gradient Texture.
 */
interface LinearGradientTexture extends Texture{

  /**
   * The angle of the linear gradient Texture.
   */
  angle: number;

  /**
   * The color stops of the linear gradient Texture.
   */
  colorStops: ColorStops;
}

/**
 * This class defines a radial gradient Texture.
 */
interface RadialGradientTexture extends Texture{

  /**
   * The color stops of the radial gradient Texture.
   */
  colorStops: ColorStops;
}

/**
 * This class defines a conic gradient Texture.
 */
interface ConicGradientTexture extends Texture{

  /**
   * The color stops of the conic gradient Texture.
   */
  colorStops: ColorStops;
}

/**
 * This class defines a Texture that consists of an image.
 */
interface PatternTexture extends Texture{

  /**
   * The image id of the pattern Texture.
   */
  imageId: int8;

  /**
   * Repeat bits of the pattern Texture. Must be one of the following:
   * 0: no-repeat
   * 1: repeat-y
   * 2: repeat-x
   * 3: repeat
 ...
 */
interface GuiClickEventHandler extends GuiEventHandler {
...
declare class GuiComponent {
  ...
  /**
   * Style ids that will be applied in the same order.
   */
  styles: uint16[];
...
interface Gui {
   ...
   * All popups.
   */
  popups: {[id: int]: GuiPopup};

  /**
   * All components.
   */
  components: {[id: int]: GuiComponent};
   ...
   * @param keys Default keys or buttons that can be used to trigger this input control.
   * 
   * @returns void.
   */
  addControl(name: string, keys: uint16[]): void;

  /**
   * Removes an input control from the controls array. Should only be used as host, before anyone has joined the room.
   * 
   * @param name Name of the input control to remove.
   * 
   * @return void.
   */
  removeControl(name: string): void;
   ...
   * 
   * @css The css text that will be added.
   * 
   * @return void.
   */
   ...
   * @param url The url that contains the sound.
   * 
   * @return void.
   */
   ...
   * 
   * @param name Unique name of the css variable
   ...
   * 
   * @params Parameters for creating a Popup.
   * 
   * @return void.
   */
...
declare class AsyncReplayReader{
   ...
   * @returns The extrapolated room state.
   */
  public extrapolate(milliseconds: number): RoomState;
   ...
   * @returns void.
   */
  public setSpeed(coefficient: number): void;
   ...
   * @returns void.
   */
  public setTime(destinationTime: int): void;
   ...
   * @returns void.
   */
  public setCurrentFrameNo(destinationFrameNo: int): void;
   ...
   * @returns void.
   */
  public onDestinationTimeReached?(): void;
...
interface RoomBase {
   ...
   * @returns void.
   */
  executeEvent(event: MooballEvent, byId: uint16): void;
   ...
   * @returns void.
   */
  executeEventWithTarget(event: MooballEvent, targetId: uint16): void;
   ...
   * @param targetId If `null`, the message is sent to everyone; otherwise, only the player whose id is `targetId` will receive this announcement. Default value = null.
   * @param color The desired color of the announcement. Range: `-1` <= `color` < `16777216`. Default value = -1.
   *   - The color value can be converted into a rgba string via API's `Utils.numberToColor` function.
   *   - The special value `-1` means transparent.
   * @param style The desired font style of the announcement. Default value = "normal". Must be one of the following:
   ...
   * @param sound The desired sound of the announcement. Default value = 1. Must be one of the following:
   *   - `0`: no sound.
   *   - `1`: chat sound.
   *   - `2`: highlight sound.
   * 
   * @returns void.
   */
  sendAnnouncement(msg: string, targetId?: uint16, color?: int, style?: string, sound?: int): void;
   ...
   * @returns void.
   */
  setPlayerIdentity(id: uint16, data: IdentityData, signature: ArrayBuffer, targetId?: uint16): void;
   ...
   * @param instant If `true`, sends the event immediately. This is introduced later to reduce input lag. Default value = true.
   * 
   * @returns void.
   */
  setKeyState(state: int, instant?: boolean): void;
   ...
   * 
   * @param playerId Id of the player that is expected to leave the room.
   * @param errorString The error message that the client will see on screen.
   * 
   * @returns The snapshot copy of the current room's state.
   */
...
type NumericIPv6 = BigInt;
type AuthString = string;
type BanEntryId = uint32;
type BanEntry = {
  id: BanEntryId;
  type: BanEntryType;
...
interface RoomStateBase {
  ...
  /**
   * Whether the game will run its default logic or not. If this value is false, 
   * you will probably want to write your own game logic from scratch in onGameTick.
   */
 ...
 */
type RoomState = (RoomStateBase & SandboxModeFunctions);
...
type RoomData = {
   ...
   * Owner of this room.
   */
  owner: { type: int8, name: string } | null;
 ...
 */
interface HostTriggeredCallbacks {
  ...
  */
   ...
   * @returns void or a custom data to pass to the next callback.
   */
  onPlayerSkinChange?(id: uint32, skin: Texture|null, customData?: any): any,
   ...
   * @returns void or a custom data to pass to the next callback.
   */
  onPlayerEnergyChange?(id: uint32, data: number[], customData?: any): any,
  
  /**
   * Called just after game input controls have been modified.
   * 
   * @param type Type of the operation. (0: add, 1: remove)
   * @param params Parameters for the specific operation.
   * @param customData the custom data that was returned from the previous callback.
   * 
   * @returns void or a custom data to pass to the next callback.
   */
  onControls?(type: uint8, params: any[], customData?: any): any,
...
interface GameCallbacks {
   ...
   * @returns void or a custom data to pass to the next callback.
   */
  onTeamGoal?(teamId: int, goalId: int, goal: Goal, ballDiscId: int, ballDisc: Disc, customData?: any): any,
...
type IndividuallyTriggeredCallbacks = GameCallbacks & LocalCallbacks & APICallbacks;
...
interface CommonCallbacks {
   ...
   * @returns void or a custom data to pass to the next callback.
   */
  onOvertimeLimitChange?(value: uint32, customData?: any): any,
   ...
   * @returns void or a custom data to pass to the next callback.
   */
  onPlayerDirectionChange?(id: uint32, value: number, customData?: any): any,
   ...
   * @returns void or a custom data to pass to the next callback.
   */
  onStadiumChange?(stadium: IStadium, byId: uint16, customData?: any): any,
...
interface ModifierCallbacks {
   ...
   * };
   */
  onOperationReceived?(type: OperationType, msg: MooballEvent, globalFrameNo: int, clientFrameNo: int, customData?: any): boolean
}
...
interface CustomCallbacks {
   ...
   * @param data Any JSON object to store the properties of the custom event. This object is converted to a string and sent/received by Mooball's original event mechanism.
   ...
   * 
   * @param type Any integer value to hold the type of the custom event.
   * @param data Any Uint8Array to store the properties of the custom event. This object is directly sent/received by Mooball's original event mechanism.
   * @param byId Id of the player who has triggered this custom event.
   * @param customData Any custom data that might be returned from the previous addon's calback.
   * 
   * @returns void or a custom data to pass to the next callback.
...
interface HostTriggeredRoomConfigCallbacks {
  ...
  */
   ...
   * @returns void or a custom data to pass to the next callback.
   */
  onBeforePlayerSkinChange?(id: uint32, skin: Texture|null): any,
   ...
   * @returns void or a custom data to pass to the next callback.
   */
  onBeforePlayerCssVarChange?(id: uint32, cssVar: string|null): any,
   ...
   * @returns void or a custom data to pass to the next callback.
   */
  onBeforePlayerEnergyChange?(id: uint32, data: number[]): any,
   ...
   * @returns void or a custom data to pass to the next callback.
   */
  onBeforeControls? (type: uint8, params: any[]): any,
...
interface GameRoomConfigCallbacks {
   ...
   * @returns void or a custom data to pass to the next callback.
   */
  onBeforeTeamGoal?(teamId: int, goalId: int, goal: Goal, ballDiscId: int, ballDisc: Disc): any,
   ...
   * @returns void.
   */
  onAfterTeamGoal?(teamId: int, goalId: int, goal: Goal, ballDiscId: int, ballDisc: Disc, customData?: any): void,
...
type IndividuallyTriggeredRoomConfigCallbacks = GameRoomConfigCallbacks & LocalRoomConfigCallbacks & APIRoomConfigCallbacks;
...
interface CommonRoomConfigCallbacks {
   ...
   * @returns void or a custom data to pass to the next callback.
   */
  onBeforeOvertimeLimitChange?(value: uint32): any,
   ...
   * @returns void.
   */
  onAfterOvertimeLimitChange?(value: uint32, customData?: any): void,
   ...
   * @returns void or a custom data to pass to the next callback.
   */
  onBeforePlayerDirectionChange?(id: uint32, value: number): any,
   ...
   * @returns void.
   */
  onAfterPlayerDirectionChange?(id: uint32, value: number, customData?: any): void,
   ...
   * @returns void or a custom data to pass to the next callback.
   */
  onBeforeStadiumChange?(stadium: IStadium, byId: uint16): any,
   ...
   * @returns void.
   */
  onAfterStadiumChange?(stadium: IStadium, byId: uint16, customData?: any): void,
...
interface ModifierRoomConfigCallbacks {
   ...
   *   - `throw exception`: break the connection of the sender of this message.
   */
  onBeforeOperationReceived?(type: OperationType, msg: MooballEvent, globalFrameNo: int, clientFrameNo: int): boolean,
   ...
   *   - `throw exception`: break the connection of the sender of this message.
   */
  onAfterOperationReceived?(type: OperationType, msg: MooballEvent, globalFrameNo: int, clientFrameNo: int, customData?: any): boolean
}
...
interface CommonlyUsedCallbacks extends HostTriggeredCallbacks, GameCallbacks, CommonCallbacks, RendererCallbacks {}


interface AllPluginCallbacks extends HostOnlyCallbacks, HostTriggeredCallbacks, ClientTriggeredCallbacks, IndividuallyTriggeredCallbacks, CommonCallbacks, ModifierCallbacks, CustomCallbacks {}


interface AllRendererCallbacks extends HostOnlyCallbacks, HostTriggeredCallbacks, ClientTriggeredCallbacks, IndividuallyTriggeredCallbacks, CommonCallbacks, CustomCallbacks, RendererCallbacks {}


interface AllRoomConfigCallbacks extends HostOnlyRoomConfigCallbacks, HostTriggeredRoomConfigCallbacks, ClientTriggeredRoomConfigCallbacks, IndividuallyTriggeredRoomConfigCallbacks, CommonRoomConfigCallbacks, ModifierRoomConfigCallbacks, CustomRoomConfigCallbacks, AllPluginCallbacks {}


type IRoom = RoomBase & AllRoomConfigCallbacks & SandboxModeFunctions & FakeEventTriggers;

/**
 * The structure that holds all of the data inside a replay file.
 */
declare class IReplayData {
   ...
   */
  events: (MooballEvent | {frameNo: int})[];
...
declare class IStyle{
   ...
   * 
   * @param id Id of the Style object.
   * @param css Contents of the Style object.
   */
  constructor(id: int16, css: string);
}

/**
 * This object holds all serializable component types that can be shown inside a popup.
 */
declare enum E_COMPONENT_TYPE {

  /**
   * A general container(div) component.
   */
  CONTAINER = 0,
  ...
  /**
   * A button (input type="button") component.
   */
  BUTTON = 2,

  /**
   * A textbox (input type="text") component.
   */
  TEXTBOX = 3,

  /**
   * A spinbox (input type="number") component.
   */
  SPINBOX = 4
}
 ...
 */
declare enum E_FUNCTION_TYPE {

  /**
   * (popupId: int16, visible: boolean)=>void. Can show/hide any registered popup in a room.
   */
  SET_POPUP_VISIBLE = 0,

  /**
   * ()=>void. Sends the contents of its neighboring components to the host.
   */
  SEND_MESSAGE_TO_HOST = 1
}

/**
 * This object holds all serializable Texture types.
 */
declare enum E_TEXTURE_TYPE {
  ...
  /**
   * A conic gradient texture.
   */
  CONIC_GRADIENT = 3,

  /**
   * A texture that consists of an image.
   */
  PATTERN = 4
}
...
type IRoomConfig = {
   ...
   * }
   */
  new (metadata?: any): (Addon & AllRoomConfigCallbacks);
  prototype: Addon;
}
...
type IPlugin = {
   ...
   * }
   */
  new (name: string, active?: boolean, metadata?: any): (Addon & AllPluginCallbacks);
  prototype: Addon;
}
...
type IRenderer = {
   ...
   * }
   */
  new (metadata?: any): (Addon & AllRendererCallbacks);
  prototype: Addon;
}
...
type Plugin = addonType & IPlugin;


type RoomConfig = addonType & IRoomConfig;


type Renderer = addonType & IRenderer;


type Library = addonType & ILibrary;
...
declare class Goal {
  ...
  /**
   * The type of this Goal. Can either be 0(no background) or 1(soccer goal background). Defaults to 0.
   */
  public type: int8;
...
declare class IStadium {
  ...
  /**
   * All images of this Stadium.
   */
  public images: StadiumImage[];

  /**
   * All textures of this Stadium.
   */
  public textures: Texture[];

  /**
   * All fonts of this Stadium.
   */
  public fonts: string[];

  /**
   * All texts of this Stadium.
   */
  public texts: StadiumText[];
  ...
  /**
   * The first stripe color of the background tiles.
   */
  public bgStripeColor1: int32;

  /**
   * The second stripe color of the background tiles.
   */
  public bgStripeColor2: int32;

  /**
   * The width of the smaller rectangle inside the penalty box.
   */
  public bgInnerRectWidth: number;

  /**
   * The height of the smaller rectangle inside the penalty box.
   */
  public bgInnerRectHeight: number;

  /**
   * The distance between the penalty spot and the goal line.
   */
  public bgPenaltyDistance: number;

  /**
   * The width of the penalty box.
   */
  public bgOuterRectWidth: number;

  /**
   * The height of the penalty box.
   */
  public bgOuterRectHeight: number;

  /**
   * The radius of the arc that exists next to the penalty box.
   */
  public bgPenaltyBoxArcRadius: number;

  /**
   * The radius of indicators that indicate the spots.
   */
  public bgSpotIndicatorRadius: number;

  /**
   * The width of the vertical buffer zones that exists at the left/right edges of the stadium.
   */
  public bgBufferWidth: number;

  /**
   * The height of the horizontal buffer zones that exists at the top/bottom edges of the stadium.
   */
  public bgBufferHeight: number;
...
interface Utils {
  ...
  /**
   * Generates a new `player_auth_key` along with its companion auth object(`authObj`) to be used as parameters to the function `Room.join`. We should store the auth key and use it later if we want to be recognized in Mooball rooms. Any internal error will result in a _rejected_ promise.
   * 
   ...
   * 
   * @returns A promise that returns the current list of open public rooms returned from the moo-hoo.com.
   * 
   * @example
   ...
   */
  compareBits(value1: NumericIPv4, value2: NumericIPv4, bitMask: NumericIPv4): boolean;
  compareBits(value1: NumericIPv6, value2: NumericIPv6, bitMask: NumericIPv6): boolean;
   ...
   */
  keyState(dirX: Direction, dirY: Direction, kick: boolean): int;
   ...
   */
  reverseKeyState(state: int): {dirX: Direction, dirY: Direction, kick: boolean};
   ...
   * }, 3);
   */
  runAfterGameTick(callback: ()=>void, ticks: int): void;
   ...
   */
  parseGeo(geoStr?: object|string, fallback?: object, retNull?: boolean): GeoLocation;
   ...
   */
  promiseWithTimeout(promise: Promise<void>, msec: int32): Promise<void>;
   ...
   */
  refreshRoomToken(params: RefreshRoomTokenParams): Promise<RefreshRoomTokenReturnValue>;
...
type Room = {
   ...
   *  - useRecaptchaToken(token): This function can be called to try the process of creating a room again whenever the recaptcha token was rejected.
   */
  join(joinParams: JoinRoomParams, commonParams: CommonNetworkRoomParams): CommonNetworkRoomReturnType;
   ...
   */
  sandbox(callbacks: CommonlyUsedCallbacks & CustomCallbacks & SandboxOnlyCallbacks, options: SandboxOptions): SandboxRoom;
   ...
   */
  streamWatcher(initialStreamData: Uint8Array, callbacks: CommonlyUsedCallbacks & CustomCallbacks, options: SandboxOptions): StreamWatcherRoom;
}
...
interface EventFactory {
   ...
   * 
   * @returns An instance of MooballEvent, or undefined if the given type is not a recognized value.
   */
   ...
   * 
   * @returns An instance of MooballEvent.
   */
   ...
   * @param avatar The new headless avatar value.
   * 
  ...
  */
   ...
   * 
   * @param id Id of the player whose identity data is desired to be changed.
   * @param data The identity data that should be received from moo-hoo.com.
   * @param signature Signature of the identity data. 
   * 
   * @returns An instance of IdentityEvent.
   */
  setPlayerIdentity(id: uint16, data: IdentityData, signature: ArrayBuffer): IdentityEvent;
   ...
   * @param value Whether the default game logic is active(1) or passive(0).
   * 
   * @returns An instance of SetRunDefaultGameLogicEvent.
   */
   ...
   * @param value New direction value of the current player.
   * 
   * @returns An instance of SendDirectionEvent
   */
   ...
   * @param skin New skin value of the player.
   * 
   * @returns An instance of SetPlayerSkinEvent.
   */
  setPlayerSkin(id: uint32, skin: Texture|null): SetPlayerSkinEvent;
   ...
   * @param value An object that is supposed to contain all parameters required to add that type of object.
   * 
   * @returns An instance of StadiumAddObjectEvent.
   */
  addStadiumObject(type: uint8, value: object): StadiumAddObjectEvent;
   ...
   * @param value An object that is supposed to contain all parameters required to update that type of object.
   * 
   * @returns An instance of StadiumUpdateObjectEvent.
   */
  updateStadiumObject(type: uint8, id: uint16, value: object): StadiumUpdateObjectEvent;
   ...
   * @returns An instance of StadiumRemoveObjectEvent.
   */
  removeStadiumObject(type: uint8, id: uint16): StadiumRemoveObjectEvent;
   ...
   * @returns An instance of SetLimitEvent.
   */
  setOvertimeLimit(value: uint32): SetLimitEvent;
   ...
   */
  setPlayerDirection(id: uint32, value: number): SetPlayerDirectionEvent;
   ...
   * @param value New elapsed time value.
   * 
   * @returns An instance of SetGamePlayValueEvent.
   */
   ...
   * @returns An instance of SetGamePlayValueEvent.
   */
  setTeamScore(teamId: uint8, value: number): SetGamePlayValueEvent;
   ...
   * @param name The new room name.
   * 
   * @returns An instance of SetRoomNameEvent.
   */
   ...
   * @param params Parameters for the specific operation.
   * 
   * @returns An instance of ControlsEvent.
   */
  controls(type: uint8, params: any[]): ControlsEvent;
   ...
   * @param value New value of the css variable.
   * 
   * @returns An instance of UpdateCssVarEvent.
   */
...
interface Replay {
   ...
   * }
   */
  read(uint8Array: Uint8Array, callbacks: CommonlyUsedCallbacks, options: ReplayReadOptions): AsyncReplayReader;
   ...
   * }
   */
  trim(replayData: IReplayData, params?: { beginFrameNo?: int, endFrameNo?: int }): void;
   ...
   * }
   */
  trimAsync(replayData: IReplayData, params?: { beginFrameNo?: int, endFrameNo?: int }): Promise<void>;
...
interface Query {
   ...
   * The coordinates should be converted into Mooball's coordinate system before being used here. You can use `transformPixelCoordToMapCoord(x, y)` and `transformMapCoordToPixelCoord(x, y)` functions defined in both DefaultRenderer and SandboxRenderer for transformations between Mooball's and browser's coordinate systems.
   * @param threshold The maximum allowed distance to the point. The unit is not in pixels, but in Mooball's units. You can use `transformPixelDistanceToMapDistance(distance)` and `transformMapDistanceToPixelDistance(distance)` functions defined in both DefaultRenderer and SandboxRenderer for transformations between Mooball's and browser's coordinate systems.
   * 
...
interface MainReturnType {
   ...
   * obtained during Mooball's event mechanism, to let us understand 
   ...
   * These values help understand whether a user is allowed to use an addon while joining a room or creating a room. They are designed to act like flags and be used in bitwise operations.
   */
  AllowFlags: typeof AllowFlags;

  /**
   * These values help understand the type of addon object we are dealing with. One of these is assigned to the "addonType" property of every Addon constructor.
   */
  AddonType: typeof AddonType;
   ...
   * ```
   */
  CollisionFlags: typeof CollisionFlags;
   ...
   * These values help understand whether the camera will follow the player or not. This is only used as a variable in all stadiums.
   */
  CameraFollow: typeof CameraFollow;
   ...
   * This type lets us understand the actual state of the game. This type only exists in a GameState object.
   */
  GamePlayState: typeof GamePlayState;

  /**
   * These are the common player positions in most football manager games.
   */
  PlayerPositionInGame: typeof PlayerPositionInGame;

  /**
   * These values help understand the type of a ban entry instance inside a room's ban list.
   */
  BanEntryType: typeof BanEntryType;

  /**
   * This object consists of functions regarding event callbacks.
   */
  Callback: Callback;
  
  /**
   * This object consists of several gui enums and classes for developers.
   */
  GUI: GUI;
  ...
  /***
   * The object that currently hosts all room operations.
   */
  Room: Room;
  ...
  /**
   * This class defines a RoomConfig object to be used inside Mooball rooms. A RoomConfig is the backbone of all Mooball bots. Every room has an internal (and initially empty) RoomConfig object built inside.
   * 
   * @example
   * // If you are using require.js library or in node.js, 
   * // API might also be defined via var API = require("mooball");
  ...
  /**
   * This class defines a Plugin object to be used inside a Mooball room. A Plugin is a piece of code that can be activated/deactivated and, when activated, enchances the current capabilities of the software or does some specific/extra tasks while still being capable of the software's original functionalities.
   * 
   * @example
   * // If you are using require.js library or in node.js, 
   * // API might also be defined via var API = require("mooball");
  ...
  /**
   * This class defines a Renderer object to be used inside a Mooball room. A Renderer is a piece of code that generates graphical representations for some objects in memory.
   * 
   * @example
   * // If you are using require.js library or in node.js, 
   * // API might also be defined via var API = require("mooball");
  ...
  /**
   * This class defines a Library object to be used inside a Mooball room. You may use the Library objects from inside other Addons.
   * 
   * @example 
   * // If you are using require.js library or in node.js, 
   * // API might also be defined via var API = require("mooball");
  ...
  /**
   * This class defines a Language object that can later be used globally across all open rooms.
   * 
   * @example
   * // If you are using require.js library or in node.js, 
   * // API might also be defined via var API = require("mooball");
...
type JSON5Like = {
  ...
  stringify(data:JSON): string
}


type PakoLike = object;
...
declare class WindowLike {
   ...
   */
  requestAnimationFrame(callback: ()=>void, ...args: any[]): number;
 ...
 * Main function 
 * */
declare function mainExport(object?: WindowLike, config?: LibConfig): MainReturnType;
